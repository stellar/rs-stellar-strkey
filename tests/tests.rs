...
fn test_strkey_rejects_private_key() {
    // The Strkey enum intentionally excludes the PrivateKeyEd25519 variant.
    // Parsing an `S…` strkey via Strkey must fail; use ed25519::PrivateKey
    // directly for that kind.
