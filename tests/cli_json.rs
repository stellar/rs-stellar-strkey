...
fn test_ed25519_public_key() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::PublicKeyEd25519(
            ed25519::PublicKey([
...
fn test_ed25519_private_key() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::PrivateKeyEd25519(
            ed25519::PrivateKey([
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00,
...
fn test_contract() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::Contract(Contract([
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ]))))
...
fn test_hash_x() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::HashX(HashX([
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ]))))
...
fn test_pre_auth_tx() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::PreAuthTx(PreAuthTx([
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ]))))
...
fn test_ed25519_muxed_account() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::MuxedAccountEd25519(
...
fn test_ed25519_signed_payload() {
    assert_eq!(
        serde_json::to_string_pretty(&DecodedJsonFormat(&Strkey::SignedPayloadEd25519(
